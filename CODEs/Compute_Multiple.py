...
from Basics import *
import KnockOff_Generating,Feature_Importance
...
def genMulti(X, n_copy, method=KnockOff_Generating.sKnockOff, scaling=True, n_parallel=cpu_count()):
    ...
    method : A function that creates X_knockoff ; default KnockOff_Generating.sKnockOff
